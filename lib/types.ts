...
export interface Account { id:string; name:string; kind:AccountKind; creditLimit?:number; balance?:number; currency:string; createdAt:string; }
...
export interface Settings { currency:string; name:string; savings:number; username?:string; companyCategories:string[]; }
